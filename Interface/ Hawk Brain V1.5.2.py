            ...
            if blu[2]>90 and blu[3]>90:          
                ...
                for bluVid in videos:
                    if selectedColour['blue'] == True:
                        cv2.rectangle(bluVid,(blu[0],blu[1]),(blu[0]+blu[2],blu[1]+blu[3]),(172,0,179),2)
...
def colourInterface():
    ...
    slider0Obj = tk.IntVar() # x value
    slider1Obj = tk.IntVar() # width value
...
def createJson():
    ...
    savingData = {
        ...
        "slider0Obj":str(objectW),
        "slider1Obj":str(objectX),
        "width":str(width),
        "height":str(height)
    }
