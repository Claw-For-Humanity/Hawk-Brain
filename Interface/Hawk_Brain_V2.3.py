...
def colourInterface():
    ...
    slider0Info = tk.Label(colourWindow, text=f'X value')
    slider0Info.place(x=30, y=213)
    
    slider1Info = tk.Label(colourWindow, text=f'width')
    ...
    Hawk_Eye_Activate_Button = tk.Checkbutton(colourWindow, text= 'Hawk Eye Activate', command= lambda: update_HawkEye())

    redBtn.place(x=30, y= 45)
    BlueBtn.place(x=130, y= 45)
    Hawk_Eye_Activate_Button.place(x= 195, y= 45)
